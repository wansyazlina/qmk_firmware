...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * | L1   | Ctrl | Win  |  Alt |  L3  |    Space    | CapL |  Up  | Left | Down |Right
       |                                                                              L2   |
     * `-----------------------------------------------------------------------------------'
     */
    [0] = LAYOUT_planck_mit(
        ...
        TT(1),KC_LCTL,KC_LGUI, KC_LALT,  TT(3),     KC_SPC, KC_CAPS, KC_LEFT, KC_UP , KC_DOWN, TD(QUOT_LAYR)
    ),
    ...
    [1] = LAYOUT_planck_mit(
        ...
        _______,  KC_U, KC_7,   KC_8,   KC_9, _______, KC_NLCK, _______, _______, _______, _______, _______,
     ...
     * |------+------+------+------+------+------+------+------+------+------+------+------|
     * | Brit+|Brit- |      | TogL1|      |      |      |      |r_Mode|Hue+  |Hue-  |      |
     * `-----------------------------------------------------------------------------------'
     */
    [2] = LAYOUT_planck_mit(
